...
class ProductCompanie(models.Model):
...
class Product(models.Model):
    ...
    product_company = models.ForeignKey(ProductCompanie, on_delete=models.CASCADE)
...
class StockOut(models.Model):
    product_info = models.ForeignKey(Stock, on_delete=models.CASCADE)
    product_sell_price = models.CharField(max_length=50)
